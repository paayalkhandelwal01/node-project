 ...
 * @returns a promise
 */
declare const getFlashMessagePr: (req: Request, key: string, config: Config) => Promise<unknown>;
/**
 * setFlashMessagePr
 * * this is a promise base function
 * * when this function runs, it will return a promise and *delete* your flash message in the session
 ...
 * @returns a promise
 */
declare const setFlashMessagePr: (req: Request, key: string, value: FlashData, config: Config) => Promise<unknown>;
