...
exports.setFlashMessageCb = exports.getFlashMessageCb = void 0;
/**
 * getFlashMessageCb
 ...
 */
var getFlashMessageCb = function (req, key, callback, config) {
...
exports.getFlashMessageCb = getFlashMessageCb;
/**
 * setFlashMessageCb
 * * this is a callback base function
 * @param req req param is the Request object that you use inside an express middleware
 ...
 * @param config this is the configuration of flashconnect
 */
var setFlashMessageCb = function (req, key, value, callback, config) {
    var storeProperty = config.storeProperty || "flash";
    if (!req.session[storeProperty])
        req.session[storeProperty] = {};
...
exports.setFlashMessageCb = setFlashMessageCb;
